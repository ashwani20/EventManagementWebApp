        ...
        <div class="container">
            <div class="card">
                <div class="card-header"> 
                        ...
                        <a href="adminaddsessionattendees.php" class="float-right btn btn-dark btn-sm">
                            <i class="fa fa-fw fa-plus-circle"></i> Add Sessions to Attendee
                        </a>
                        <a style = "margin-right:10px;" href="adminattendeereg.php" class="float-right btn btn-dark btn-sm">
                            Attendee Page
                        </a>
                </div>
                ...
                <div class="card-body">
                    <div class="col-sm-12">
                        ...
                        <form action="adminregattendsession.php" method="POST">
                            <div class="row">
                                <div class="col-sm-2">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    ?>
                            <tr>
                                ...
                                <td align="center">
                                    <a href="admineditsessionattendees.php?editIdAttendee=<?php echo $val['AttendeeID'];?>&editIdSession=<?php echo $val['idsession'];?>" class="text-primary"><i class="fa fa-fw fa-edit"></i> Edit</a> 
                                    <a href="admindeletesessionattendees.php?editIdAttendee=<?php echo$val['AttendeeID'];?>&editIdSession=<?php echo $val['idsession'];?>" class="text-danger" onClick="return confirm('Are you sure to delete this record?');"><i class="fa fa-fw fa-trash"></i> Delete</a>
                                </td>
                            </tr>
                            <?php
                                }
