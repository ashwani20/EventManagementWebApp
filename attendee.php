...
<html lang="en">
  ...
  <body>
    <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
        <h5 class="my-0 mr-md-auto font-weight-normal"> <a href="attendee.php">BookMyEvent</a></h5>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 shadow-sm">
                            ...
                            <div class="card-body text-center">
                                <a class="card-text" href = "regattendevent.php">Manage your Events</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card mb-4 shadow-sm">
                            <svg class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: Thumbnail"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"/><text x="50%" y="50%" fill="#eceeef" dy=".3em">Thumbnail</text></svg>
                            <div class="card-body text-center">
                                <a class="card-text" href = "regattendsession.php">Manage your Session</a>
                            </div>
                        </div>
                    </div>
                </div>
