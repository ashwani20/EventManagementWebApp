        ...
        <div class="container">
            <div class="card">
                <div class="card-header"> 
                        ...
                        <a href="eventmanageraddsessions.php" class="float-right btn btn-dark btn-sm">
                ...
                <div class="card-body">
                    <div class="col-sm-12">
                        ...
                        <form action="eventmanagerbrowsesessions.php" method="POST">
                            <div class="row">
                                <div class="col-sm-2">
                    ...
                    <tbody>
                        <?php
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a href="eventmanagereditsessions.php?editId=<?php echo $val['idsession'];?>" class="text-primary"><i class="fa fa-fw fa-edit"></i> Edit</a> | 
                                    <a href="eventmanagerdeletesessions.php?delId=<?php echo$val['idsession'];?>" class="text-danger" onClick="return confirm('Are you sure to delete this session?');"><i class="fa fa-fw fa-trash"></i> Delete</a>
                                </td>
